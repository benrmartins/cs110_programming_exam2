...
class Quadratic:
    ...
    def roots(self):
        root1 = (-(self._b) + math.sqrt(self._b ** 2 - 4 * self._a * self._c)) / (2 * self._a)
        root2 = (-(self._b) - math.sqrt(self._b ** 2 - 4 * self._a * self._c)) / (2 * self._a)
        return (root1, root2)
    ...
    def __eq__(self, other):
        return other.sum() == self.sum() and other.prod() == self.prod()
